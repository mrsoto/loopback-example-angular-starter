...
Thank you for your interest in `loopback-example-angular-starter`, an open source project
administered by StrongLoop.

Contributing to `loopback-example-angular-starter` is easy. In a few simple steps:
